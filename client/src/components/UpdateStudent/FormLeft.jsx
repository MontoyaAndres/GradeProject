...
const FormLeft = ({ classes, SelectData, errors, values, handleBlur, handleChange }) => (
  <Grid container>
    <Grid item xs={12}>
      <Grid container justify="center" wrap="wrap">
        ...
        <Grid item xs={12} sm={6}>
          ...
          <div style={{ padding: 10 }}>
            <FormControl className={classes.textField}>
              <InputLabel htmlFor="TipoSemestre">Tipo semestre</InputLabel>
              <Input
                id="TipoSemestre"
...
export default withStyles(styles)(FormLeft);
